...
public class RSA3 {
    ...
    public static void main(String[] arg) {
        ...
        //String abeceda = "abcdefghiíjklmnopqrstuvwxyzěščřžýáíéúů01234567890"
        
        String text = " Šel dědeček na kopeček uříznout si šnitlík, náhle se mu ruka smekla, uříznul si pytlík.";
        
        BigInteger m = null;      
        try {
            m = new BigInteger(text.getBytes("UTF-8"));
        } catch (UnsupportedEncodingException ex) {
            Logger.getLogger(RSA3.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        String hhh = null;
        try {
             hhh = new String(m.toByteArray(),"UTF-8");
        } catch (UnsupportedEncodingException ex) {
            Logger.getLogger(RSA3.class.getName()).log(Level.SEVERE, null, ex);
        }
