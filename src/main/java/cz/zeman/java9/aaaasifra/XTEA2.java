...
public class XTEA2 {
    ...
    public  static void  main(String[] arg) throws UnsupportedEncodingException {
        ...
        BigInteger bi1 = new BigInteger("61626364", 16);
        BigInteger bi2 = new BigInteger("71727374", 16);
        BigInteger bi3 = new BigInteger("81828384", 16);
        BigInteger bi4 = new BigInteger("91929394", 16);
        int[] klic = new int[4];
        klic[0] = bi1.intValue();
        klic[1] = bi2.intValue();
        klic[2] = bi3.intValue();
        ...
        XTEA2 xtea = new XTEA2(klic);
        
        String plainText = "Vytřel bych ti zrak ...";
        byte[] plainArray = plainText.getBytes("UTF-8");
        System.out.println("VSTUP");
        for (int i = 0; i < plainArray.length; i++) {
           System.out.format("x%02X\n", plainArray[i]);
        }
        xtea.encrypt(plainArray);
        System.out.println("ZASIFROVANO");
        for (int i = 0; i < plainArray.length; i++) {
           System.out.format("x%02X\n", plainArray[i]);
        }
        xtea.decrypt(plainArray);
     ...
     * @param iterationSpec The iteration spec containing iterations count.
     * Possible values are 8, 16, 32 and 64.
     *
     */
    /*
	public XTEA2(String key, IterationSpec iterationSpec) {
     ...
     *
     */
    public XTEA2(int[] key, IterationSpec iterationSpec) throws IllegalArgumentException {
        if (key.length != 4) {
     ...
     * @param res byte array of length eight which contains converted integer
     * array i.
     */
     ...
     *
     * @param block int array to be encipher according to the XTEA encryption
     * algorithm<br>
     */
     ...
     *
     * @param e_block int array to be decipher according to the XTEA encryption
     * algorithm<br>
     */
